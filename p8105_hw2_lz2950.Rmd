...
The total weight of trash collected by Professor Trash Wheel is `r sum(prof_trash_wheel$weight_tons)` and the total number of cigarette butts collected by Gwynnda in July of 2021 is `r gwy_trash_wheel |> filter(year == 2021 & month == "July") |> pull(cigarette_butts) |> sum()`.
